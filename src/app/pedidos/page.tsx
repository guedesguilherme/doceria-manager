        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-3 text-center">
              ...
              <div className="text-xs text-blue-500">A receber</div>
            </CardContent>
          </Card>
        </div>
      )}
      ...
      {filteredOrders.length === 0 ? (
        <Card>
          <CardContent className="text-center py-16">
            <ShoppingCart className="w-12 h-12 mx-auto mb-3 text-blue-200" />
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="text-right flex-shrink-0 space-y-2">
                    <div className="font-bold text-blue-600">{formatCurrency(order.totalAmount ?? 0)}</div>
                    ...
                    <div className="flex flex-col gap-1">
                      {order.status !== 'Entregue' && (
                        <select
                          className="text-xs border border-blue-200 rounded px-1.5 py-1 bg-white focus:outline-none focus:ring-1 focus:ring-blue-400"
                          value={order.status}
