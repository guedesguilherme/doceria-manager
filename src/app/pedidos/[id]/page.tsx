      ...
      try {
        ...
        if (orderRes.ok) {
          ...
          setForm({
            ...
            deliveryDatetime: formatDatetimeLocal(order.deliveryDatetime),
            deliveryType: order.deliveryType,
            notes: order.notes ?? '',
            status: order.status,
            signalAmount: String(order.signalAmount ?? ''),
          })
          setItems(order.items?.map((item: {
            ...
            recipeName: item.recipeName ?? 'Receita',
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {totalAmount > 0 && (
              <div className="bg-mint-50 rounded-lg p-3 text-sm space-y-1">
                ...
                {Number(form.signalAmount) > 0 && (
                  <>
                    ...
                    <div className="flex justify-between text-mint-600 font-semibold border-t border-mint-200 pt-1">
                      <span>Restante</span>
